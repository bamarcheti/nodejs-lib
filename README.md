# 🧠 JavaScript com Node.js - Criando a sua primeira biblioteca

> Repositório criado como parte da **Formação JavaScript para Back-end** da [Alura](https://www.alura.com.br/), com foco em criação de biblioteca em JavaScript com Node.js.

## **📚 Curso relacionado**

Este projeto faz parte do módulo:  
**👉 Conhecendo JavaScript com Node.js – JavaScript para Back-end**
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/bamarcheti/nodejs-lib
   cd nodejs-lib
   npm install
